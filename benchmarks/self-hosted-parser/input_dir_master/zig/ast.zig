...
pub const Tree = struct {
    ...
    pub fn renderError(self: *Tree, parse_error: *Error, stream: anytype) !void {
...
pub const Error = union(enum) {
    ...
    pub fn render(self: *const Error, tokens: *Tree.TokenList, stream: anytype) !void {
        switch (self.*) {
    ...
    pub const ExpectedCall = struct {
        ...
        pub fn render(self: *const ExpectedCall, tokens: *Tree.TokenList, stream: anytype) !void {
    ...
    pub const ExpectedCallOrFnProto = struct {
        ...
        pub fn render(self: *const ExpectedCallOrFnProto, tokens: *Tree.TokenList, stream: anytype) !void {
    ...
    pub const ExpectedToken = struct {
        ...
        pub fn render(self: *const ExpectedToken, tokens: *Tree.TokenList, stream: anytype) !void {
    ...
    pub const ExpectedCommaOrEnd = struct {
        ...
        pub fn render(self: *const ExpectedCommaOrEnd, tokens: *Tree.TokenList, stream: anytype) !void {
