...
test "floatditf" {
    ...
    try test__floatditf(@as(i64, @bitCast(@as(u64, 0xffffffffffffffff))), make_ti(0xbfff000000000000, 0x0));
    try test__floatditf(@as(i64, @bitCast(@as(u64, 0xfffffffffffffffe))), make_ti(0xc000000000000000, 0x0));
    try test__floatditf(-0x123456789abcdef1, make_ti(0xc03b23456789abcd, 0xef10000000000000));
    try test__floatditf(@as(i64, @bitCast(@as(u64, 0x8000000000000000))), make_ti(0xc03e000000000000, 0x0));
}
