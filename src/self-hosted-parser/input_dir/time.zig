...
pub const Timer = struct {
    ...
    pub fn start() Error!Timer {
        ...
        if (is_windows) {
            ...
            return Timer{
                .resolution = @as(u64, @intCast(res.tv_sec)) * ns_per_s + @as(u64, @intCast(res.tv_nsec)),
                .start_time = @as(u64, @intCast(ts.tv_sec)) * ns_per_s + @as(u64, @intCast(ts.tv_nsec)),
                .frequency = {},
            };
        }
    }
    ...
    fn clockNative() u64 {
        ...
        return @as(u64, @intCast(ts.tv_sec)) * @as(u64, ns_per_s) + @as(u64, @intCast(ts.tv_nsec));
    }
